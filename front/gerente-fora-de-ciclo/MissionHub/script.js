...
axios.get("./mock.json")
    .then(response => {
        ...
        items.forEach(item => {
            ...
            divAvatar.textContent = getInitials(item.name);
            ...
            divItem.addEventListener("click", () => {
                window.location.href = '/gerente-fora-de-ciclo/mission-register/index.html';
            });
...
btnVoltar.addEventListener("click", () => {
    makeBottomSheet({
        ...
        onCancel: () => {
            ...
            window.location = '/gerente-fora-de-ciclo/create-cycle/index.html'
        },
        onConfirm: () => {window.location = '/gerente-fora-de-ciclo/create-cycle/index.html'}
    });
});
...
function postMissions(route) {
    ...
    if (route === "next") {
        window.location.href = '/gerente-fora-de-ciclo/loading/index.html';
    }
}
